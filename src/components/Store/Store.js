...
const Store = () => {
  ...
  const filteredStores = stores.filter((store) => {
    // Chỉ trả về cửa hàng nếu có chủ và trạng thái của chủ cửa hàng khớp với filterStatus
    return store.owner && (filterStatus === null || store.owner.isOnline === filterStatus);
  });
